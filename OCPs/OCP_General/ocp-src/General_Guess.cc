...
namespace GeneralDefine {
  ...
  void
  General::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  General::xlambda_guess_eval(
    integer              i_segment,
  ...
  bool
  General::p_check( P_const_pointer_type P__ ) const {
    bool ok = true;
