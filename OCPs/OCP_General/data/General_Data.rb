...
mechatronix do |data|
  ...
  data.BoundaryConditions = {
    ...
    :cyclic_omega__f      => SET,
    :cyclic_phi__dot      => SET,
    :cyclic_theta__dot    => SET,
    :cyclic_h__dot        => SET,
    :cyclic_delta__dot    => SET,
    :cyclic_eta__dot      => SET,
    :cyclic_s__f__dot     => SET,
    :cyclic_x__f__dot     => SET,
    :cyclic_y__f__dot     => SET,
    :cyclic_z__f__dot     => SET,
    :cyclic_x__r__dot     => SET,
    :cyclic_y__r__dot     => SET,
    :cyclic_z__r__dot     => SET,
    :cyclic_delta__f__dot => SET,
    :cyclic_phi__f__dot   => SET,
    :cyclic_Ftr           => SET,
    :cyclic_Mbf           => SET,
    :cyclic_Mbr           => SET,
    :cyclic_tau           => SET,
