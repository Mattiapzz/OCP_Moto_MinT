...
%ocp.setup(General_data);
%ocp.setup('../../data/General_Data.lua');
ocp.setup('../../data/General_Data.rb');
...
%%clear mex
%x = General_Mex('get_raw_solution',obj);
%J = General_Mex('eval_JF',obj,x);
%f = General_Mex('eval_F',obj,x);
