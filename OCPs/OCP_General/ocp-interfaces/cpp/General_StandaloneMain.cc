...
main() {
  ...
  try {
    ...
    General          model("General",&TP,&console);
...
General_data.Engine["Gear_ratio"][0] = 4.82;
General_data.Engine["Gear_ratio"][1] = 2.5;
General_data.Engine["Gear_ratio"][2] = 1.75;
General_data.Engine["Gear_ratio"][3] = 1.368;
General_data.Engine["Gear_ratio"][4] = 1.09;
General_data.Engine["Gear_ratio"][5] = 0.956;
General_data.Engine["Gear_ratio"][6] = 0.851;
General_data.Engine["Rpm"][0] = 0;
General_data.Engine["Rpm"][1] = 3000;
General_data.Engine["Rpm"][2] = 3500;
General_data.Engine["Rpm"][3] = 4000;
General_data.Engine["Rpm"][4] = 4500;
General_data.Engine["Rpm"][5] = 5000;
General_data.Engine["Rpm"][6] = 5500;
General_data.Engine["Rpm"][7] = 6000;
General_data.Engine["Rpm"][8] = 6500;
General_data.Engine["Rpm"][9] = 7000;
General_data.Engine["Rpm"][10] = 7500;
General_data.Engine["Rpm"][11] = 8000;
General_data.Engine["Rpm"][12] = 8500;
General_data.Engine["Rpm"][13] = 9000;
General_data.Engine["Rpm"][14] = 9500;
General_data.Engine["Rpm"][15] = 10000;
General_data.Engine["Rpm"][16] = 10500;
General_data.Engine["Rpm"][17] = 11000;
General_data.Engine["Rpm"][18] = 11500;
General_data.Engine["Rpm"][19] = 12000;
General_data.Engine["Rpm"][20] = 12500;
General_data.Engine["Rpm"][21] = 13000;
General_data.Engine["Torque"][0] = 2;
General_data.Engine["Torque"][1] = 47.088;
General_data.Engine["Torque"][2] = 62.784;
General_data.Engine["Torque"][3] = 70.632;
General_data.Engine["Torque"][4] = 78.48;
General_data.Engine["Torque"][5] = 84.366;
General_data.Engine["Torque"][6] = 85.347;
General_data.Engine["Torque"][7] = 83.385;
General_data.Engine["Torque"][8] = 81.423;
General_data.Engine["Torque"][9] = 90.252;
General_data.Engine["Torque"][10] = 92.214;
General_data.Engine["Torque"][11] = 87.309;
General_data.Engine["Torque"][12] = 85.347;
General_data.Engine["Torque"][13] = 84.366;
General_data.Engine["Torque"][14] = 80.442;
General_data.Engine["Torque"][15] = 79.461;
General_data.Engine["Torque"][16] = 73.575;
General_data.Engine["Torque"][17] = 63.765;
General_data.Engine["Torque"][18] = 49.05;
General_data.Engine["Torque"][19] = 29.43;
General_data.Engine["Torque"][20] = 19.62;
General_data.Engine["Torque"][21] = 2;
    ...
    ofstream file;
    if ( ok ) {
      file.open( "data/General_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/General_OCP_not_converged.txt" );
    }
    file.precision(18);
