...
w__t0             = 1/100000.0
w__t              = w__t0
long_peak_rear_0  = 0.04
long_peak_rear    = long_peak_rear_0
eps_c             = eps_c0
w__ic0            = 1
tol_c             = tol_c0
long_peak_front_0 = 0.04
long_peak_front   = long_peak_front_0
w__ss0            = 1
tol_p             = tol_p0
tol_c1            = 0.01
w__LR0            = 100
...
mechatronix do |data|
  ...
  data.Parameters[:beta__max              ] = 1/15.00*Math::PI
  data.Parameters[:closed_gas             ] = closed_gas
  data.Parameters[:delta__dot__ss         ] = 0
  data.Parameters[:delta__max             ] = 1/9.00*Math::PI
  ...
  data.Parameters[:long_peak_front        ] = long_peak_front
  data.Parameters[:long_peak_rear         ] = long_peak_rear
  data.Parameters[:m__delta               ] = 8.75
  data.Parameters[:not_braking            ] = not_braking
  data.Parameters[:omega__n               ] = 20
  ...
  data.Parameters[:eps_c1           ] = 1/10000.00
  data.Parameters[:eps_p0           ] = eps_p0
  data.Parameters[:eps_p1           ] = 1/10000.00
  data.Parameters[:tol_c0           ] = tol_c0
  data.Parameters[:tol_c1           ] = tol_c1
  ...
  data.Parameters[:long_peak_front_0] = long_peak_front_0
  data.Parameters[:long_peak_front_1] = 0.15
  data.Parameters[:long_peak_rear_0 ] = long_peak_rear_0
  data.Parameters[:long_peak_rear_1 ] = 0.15
