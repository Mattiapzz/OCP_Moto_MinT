...
namespace MidLineDefine {
  ...
  class MidLine_Problem {
    ...
    MidLine_Problem( MidLine_Problem const & );
    MidLine_Problem const & operator = ( MidLine_Problem const & );
  ...
  public:
    ...
    MIDLINE_API_DLL
    MidLine_Problem( ThreadPool * pTP, Console * pConsole )
    : model("MidLine",pTP,pConsole)
    , engine( "engine" )
    , road( "road" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "MidLine::solver, fatal: unknown error";
      }
      return ok;
    }
