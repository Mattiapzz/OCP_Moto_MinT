...
namespace MidLineDefine {
  ...
  void
  MidLine::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  MidLine::xlambda_guess_eval(
    integer              i_segment,
    ...
    X__[ iX_u             ] = ModelPars[129];
    X__[ iX_v             ] = ModelPars[131];
    X__[ iX_Omega         ] = ModelPars[164];
    X__[ iX_phi           ] = ModelPars[93];
    X__[ iX_theta         ] = ModelPars[213];
    X__[ iX_h             ] = ModelPars[70];
    X__[ iX_delta         ] = ModelPars[171];
    X__[ iX_eta           ] = ModelPars[66];
    X__[ iX_s__f          ] = ModelPars[201];
    X__[ iX_x__f          ] = ModelPars[219];
    X__[ iX_y__f          ] = ModelPars[227];
    X__[ iX_z__f          ] = ModelPars[237];
    X__[ iX_x__r          ] = ModelPars[223];
    X__[ iX_y__r          ] = ModelPars[231];
    X__[ iX_z__r          ] = ModelPars[241];
    X__[ iX_delta__f      ] = ModelPars[170];
    X__[ iX_phi__f        ] = ModelPars[196];
    X__[ iX_omega__r      ] = ModelPars[189];
    X__[ iX_omega__f      ] = ModelPars[186];
    X__[ iX_phi__dot      ] = ModelPars[192];
    X__[ iX_theta__dot    ] = ModelPars[211];
    X__[ iX_h__dot        ] = ModelPars[178];
    X__[ iX_delta__dot    ] = ModelPars[167];
    X__[ iX_eta__dot      ] = ModelPars[175];
    X__[ iX_s__f__dot     ] = ModelPars[199];
    X__[ iX_x__f__dot     ] = ModelPars[217];
    X__[ iX_y__f__dot     ] = ModelPars[225];
    X__[ iX_z__f__dot     ] = ModelPars[235];
    X__[ iX_x__r__dot     ] = ModelPars[221];
    X__[ iX_y__r__dot     ] = ModelPars[229];
    X__[ iX_z__r__dot     ] = ModelPars[239];
    X__[ iX_delta__f__dot ] = ModelPars[243];
    X__[ iX_phi__f__dot   ] = ModelPars[194];
    X__[ iX_Ftr           ] = ModelPars[4];
    X__[ iX_Mbf           ] = ModelPars[25];
    X__[ iX_Mbr           ] = ModelPars[26];
    X__[ iX_tau           ] = ModelPars[123];
    X__[ iX_n             ] = ModelPars[78];
    X__[ iX_xi            ] = ModelPars[148];
  ...
  bool
  MidLine::p_check( P_const_pointer_type P__ ) const {
    bool ok = true;
