...
%ocp.setup(MidLine_data);
%ocp.setup('../../data/MidLine_Data.lua');
ocp.setup('../../data/MidLine_Data.rb');
...
%%clear mex
%x = MidLine_Mex('get_raw_solution',obj);
%J = MidLine_Mex('eval_JF',obj,x);
%f = MidLine_Mex('eval_F',obj,x);
