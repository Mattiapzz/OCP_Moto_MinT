...
namespace BaumgarteDefine {
  ...
  class Baumgarte_Problem {
    ...
    Baumgarte_Problem( Baumgarte_Problem const & );
    Baumgarte_Problem const & operator = ( Baumgarte_Problem const & );
  ...
  public:
    ...
    BAUMGARTE_API_DLL
    Baumgarte_Problem( ThreadPool * pTP, Console * pConsole )
    : model("Baumgarte",pTP,pConsole)
    , engine( "engine" )
    , road( "road" )
    {
    ...
    setup( GenericContainer & gc_data, string & error ) {
      ...
      try {
        ...
        */
        ...
        error = "Baumgarte::solver, fatal: unknown error";
      }
      return ok;
    }
