...
content = {
  ...
  Parameters = {
    ...
    Mbf__max                = 800,
    Mbr__max                = 800,
    beta__max               = 1/15.0*Math::PI,
    closed_gas              = closed_gas,
    delta__dot__ss          = 0,
    delta__max              = 1/9.0*Math::PI,
    eta__dot__ss            = 0,
    h__dot__ss              = 0,
    lat_peak_front          = 1,
    lat_peak_rear           = 1,
    long_peak_front         = long_peak_front,
    long_peak_rear          = long_peak_rear,
    m__delta                = 8.75,
    ...
    w__t0             = w__t0,
    w__t1             = 1,
    long_peak_front_0 = long_peak_front_0,
    long_peak_front_1 = 0.15,
    long_peak_rear_0  = long_peak_rear_0,
    long_peak_rear_1  = 0.15,
  ...
  -- Barrier subtype: "BARRIER_LOG", "BARRIER_LOG_EXP", "BARRIER_LOG0"
    ...
    -- PenaltyBarrier1DInterval
    MaxBetaAnglesubType   = "PENALTY_REGULAR",
    MaxBetaAngleepsilon   = eps_p,
    MaxBetaAngletolerance = tol_p,
    MaxBetaAnglemin       = -1,
    MaxBetaAnglemax       = 1,
    MaxBetaAngleactive    = true
