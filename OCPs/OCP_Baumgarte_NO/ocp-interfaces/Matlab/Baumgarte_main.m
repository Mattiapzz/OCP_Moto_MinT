...
%ocp.setup(Baumgarte_data);
%ocp.setup('../../data/Baumgarte_Data.lua');
ocp.setup('../../data/Baumgarte_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Baumgarte_Mex('set_tracked',obj,tracked);
...
%%clear mex
%x = Baumgarte_Mex('get_raw_solution',obj);
%J = Baumgarte_Mex('eval_JF',obj,x);
%f = Baumgarte_Mex('eval_F',obj,x);
