...
% create object
ocp = Test_Convergence( 'Test_Convergence' );
...
%ocp.setup(Test_Convergence_data);
%ocp.setup('../../data/Test_Convergence_Data.lua');
ocp.setup('../../data/Test_Convergence_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Test_Convergence_Mex('set_tracked',obj,tracked);
...
%%clear mex
%x = Test_Convergence_Mex('get_raw_solution',obj);
%J = Test_Convergence_Mex('eval_JF',obj,x);
%f = Test_Convergence_Mex('eval_F',obj,x);
