...
############################################################################
#                                                                          #
#  file: Test_Convergence_ffi_structs.rb                                   #
#                                                                          #
...
module Test_Convergence
  ...
  class Test_Convergence_solver_params < FFI::Struct
    layout(
      :max_iter,             :index_t,
  ...
  class Test_Convergence_model_params < FFI::Struct
    layout(
  ...
  class Test_Convergence_BC_params < FFI::Struct
    layout(
  ...
  class Test_Convergence_constraints_params < FFI::Struct
    layout(
      # 1D constraints
  ...
  attach_function :setup_model,                          # ruby name
                  :Test_Convergence_setup_model,        # C name
                  [:pointer ,:pointer ,:pointer ],
                  :void

  attach_function :setup_solver,                         # ruby name
                  :Test_Convergence_setup_solver,       # C name
                  [:pointer ],
                  :void

  attach_function :write_solution_to_file,                   # ruby name
                  :Test_Convergence_write_solution_to_file, # C name
                  [:string],
                  :void

  attach_function :printout_enabled?,                       # ruby name
                  :Test_Convergence_printout_is_enabled,   # C name
                  [],
                  :int

  attach_function :enable_printout,                      # ruby name
                  :Test_Convergence_enable_printout,    # C name
                  [],
                  :void

  attach_function :disable_printout,                     # ruby name
                  :Test_Convergence_disable_printout,   # C name
                  [],
                  :void

  attach_function :reset_multiplier,                     # ruby name
                  :Test_Convergence_reset_multiplier,   # C name
                  [],
                  :void

  attach_function :reset_BC_multiplier,                     # ruby name
                  :Test_Convergence_reset_BC_multiplier,   # C name
                  [],
                  :void

  attach_function :set_internal_guess,                     # ruby name
                  :Test_Convergence_set_internal_guess,   # C name
                  [],
                  :void

end

# EOF: Test_Convergence_ffi_stucts.rb
