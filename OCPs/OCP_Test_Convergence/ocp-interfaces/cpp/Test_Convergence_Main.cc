...
main() {
  ...
  try {
    Test_Convergence * pModel = new Test_Convergence("Test_Convergence",&TP,&console);
    ...
    string fname = "./data/Test_Convergence_Data.rb";
    #endif
    #ifdef MECHATRONIX_USE_LUA
    string fname = "./data/Test_Convergence_Data.lua";
    #endif
