...
main() {
  ...
  try {
    ...
    Test_Convergence model("Test_Convergence",&TP,&console);
   ...
   real_type w__ic = w__ic0;
    ...
    gc_data["DumpFile"] = "Test_Convergence_dump";
    ...
    data_Parameters["delta__max"] = 1/18.000*Math::PI;
    ...
    data_Parameters["long_peak_front"] = 0.11;
    data_Parameters["long_peak_rear"] = 0.11;
    ...
    data_Parameters["h_c0"] = h_c0;
    data_Parameters["h_c1"] = 0.01;
    ...
    data_OnlyBrakingFront["active"]    = false;
    // PenaltyBarrier1DGreaterThan
    ...
    data_OnlyBrakingRear["active"]    = false;
    // PenaltyBarrier1DGreaterThan
    ...
    data_OnlyTractionRear["active"]    = false;
    // PenaltyBarrier1DGreaterThan
...
Test_Convergence_data.Engine["Gear_ratio"][0] = 4.82;
Test_Convergence_data.Engine["Gear_ratio"][1] = 2.5;
Test_Convergence_data.Engine["Gear_ratio"][2] = 1.75;
Test_Convergence_data.Engine["Gear_ratio"][3] = 1.368;
Test_Convergence_data.Engine["Gear_ratio"][4] = 1.09;
Test_Convergence_data.Engine["Gear_ratio"][5] = 0.956;
Test_Convergence_data.Engine["Gear_ratio"][6] = 0.851;
Test_Convergence_data.Engine["Rpm"][0] = 0;
Test_Convergence_data.Engine["Rpm"][1] = 3000;
Test_Convergence_data.Engine["Rpm"][2] = 3500;
Test_Convergence_data.Engine["Rpm"][3] = 4000;
Test_Convergence_data.Engine["Rpm"][4] = 4500;
Test_Convergence_data.Engine["Rpm"][5] = 5000;
Test_Convergence_data.Engine["Rpm"][6] = 5500;
Test_Convergence_data.Engine["Rpm"][7] = 6000;
Test_Convergence_data.Engine["Rpm"][8] = 6500;
Test_Convergence_data.Engine["Rpm"][9] = 7000;
Test_Convergence_data.Engine["Rpm"][10] = 7500;
Test_Convergence_data.Engine["Rpm"][11] = 8000;
Test_Convergence_data.Engine["Rpm"][12] = 8500;
Test_Convergence_data.Engine["Rpm"][13] = 9000;
Test_Convergence_data.Engine["Rpm"][14] = 9500;
Test_Convergence_data.Engine["Rpm"][15] = 10000;
Test_Convergence_data.Engine["Rpm"][16] = 10500;
Test_Convergence_data.Engine["Rpm"][17] = 11000;
Test_Convergence_data.Engine["Rpm"][18] = 11500;
Test_Convergence_data.Engine["Rpm"][19] = 12000;
Test_Convergence_data.Engine["Rpm"][20] = 12500;
Test_Convergence_data.Engine["Rpm"][21] = 13000;
Test_Convergence_data.Engine["Torque"][0] = 2;
Test_Convergence_data.Engine["Torque"][1] = 47.088;
Test_Convergence_data.Engine["Torque"][2] = 62.784;
Test_Convergence_data.Engine["Torque"][3] = 70.632;
Test_Convergence_data.Engine["Torque"][4] = 78.48;
Test_Convergence_data.Engine["Torque"][5] = 84.366;
Test_Convergence_data.Engine["Torque"][6] = 85.347;
Test_Convergence_data.Engine["Torque"][7] = 83.385;
Test_Convergence_data.Engine["Torque"][8] = 81.423;
Test_Convergence_data.Engine["Torque"][9] = 90.252;
Test_Convergence_data.Engine["Torque"][10] = 92.214;
Test_Convergence_data.Engine["Torque"][11] = 87.309;
Test_Convergence_data.Engine["Torque"][12] = 85.347;
Test_Convergence_data.Engine["Torque"][13] = 84.366;
Test_Convergence_data.Engine["Torque"][14] = 80.442;
Test_Convergence_data.Engine["Torque"][15] = 79.461;
Test_Convergence_data.Engine["Torque"][16] = 73.575;
Test_Convergence_data.Engine["Torque"][17] = 63.765;
Test_Convergence_data.Engine["Torque"][18] = 49.05;
Test_Convergence_data.Engine["Torque"][19] = 29.43;
Test_Convergence_data.Engine["Torque"][20] = 19.62;
Test_Convergence_data.Engine["Torque"][21] = 2;
    ...
    ofstream file;
    if ( ok ) {
      file.open( "data/Test_Convergence_OCP_result.txt" );
    } else {
      cout << gc_solution("solver_message").get_string() << '\n';
      // dump solution to file
      file.open( "data/Test_Convergence_OCP_not_converged.txt" );
    }
    file.precision(18);
