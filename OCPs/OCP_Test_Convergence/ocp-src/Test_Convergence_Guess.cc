/*-----------------------------------------------------------------------*\
 |  file: Test_Convergence_Guess.cc                                      |
 |                                                                       |
...
namespace Test_ConvergenceDefine {
  ...
  void
  Test_Convergence::p_guess_eval( P_pointer_type P__ ) const {
  }

  void
  Test_Convergence::xlambda_guess_eval(
    integer              i_segment,
    ...
    X__[ iX_u             ] = ModelPars[130];
    X__[ iX_v             ] = ModelPars[131];
    X__[ iX_Omega         ] = ModelPars[161];
    X__[ iX_phi           ] = ModelPars[95];
    X__[ iX_theta         ] = ModelPars[200];
    X__[ iX_h             ] = ModelPars[70];
    X__[ iX_delta         ] = ModelPars[166];
    X__[ iX_eta           ] = ModelPars[67];
    X__[ iX_s__f          ] = ModelPars[191];
    X__[ iX_x__f          ] = ModelPars[236];
    X__[ iX_y__f          ] = ModelPars[240];
    X__[ iX_z__f          ] = ModelPars[246];
    X__[ iX_x__r          ] = ModelPars[238];
    X__[ iX_y__r          ] = ModelPars[242];
    X__[ iX_z__r          ] = ModelPars[248];
    X__[ iX_delta__f      ] = ModelPars[164];
    X__[ iX_phi__f        ] = ModelPars[187];
    X__[ iX_omega__r      ] = ModelPars[183];
    X__[ iX_omega__f      ] = ModelPars[181];
    X__[ iX_phi__dot      ] = ModelPars[185];
    X__[ iX_theta__dot    ] = ModelPars[199];
    X__[ iX_h__dot        ] = ModelPars[170];
    X__[ iX_delta__dot    ] = ModelPars[163];
    X__[ iX_eta__dot      ] = ModelPars[169];
    X__[ iX_s__f__dot     ] = ModelPars[190];
    X__[ iX_x__f__dot     ] = ModelPars[235];
    X__[ iX_y__f__dot     ] = ModelPars[239];
    X__[ iX_z__f__dot     ] = ModelPars[245];
    X__[ iX_x__r__dot     ] = ModelPars[237];
    X__[ iX_y__r__dot     ] = ModelPars[241];
    X__[ iX_z__r__dot     ] = ModelPars[247];
    X__[ iX_delta__f__dot ] = ModelPars[249];
    X__[ iX_phi__f__dot   ] = ModelPars[186];
    X__[ iX_Ftr           ] = ModelPars[4];
    X__[ iX_Mbf           ] = ModelPars[26];
    X__[ iX_Mbr           ] = ModelPars[27];
    X__[ iX_tau           ] = ModelPars[125];
    X__[ iX_n             ] = ModelPars[80];
    X__[ iX_xi            ] = ModelPars[149];
  ...
  bool
  Test_Convergence::p_check( P_const_pointer_type P__ ) const {
    bool ok = true;
  ...
  bool
  Test_Convergence::xlambda_check_node(
    integer              ipos,
  ...
  bool
  Test_Convergence::xlambda_check_cell(
    integer              icell,
    NodeType2 const    & NODE__,
    P_const_pointer_type P__
  ) const {
