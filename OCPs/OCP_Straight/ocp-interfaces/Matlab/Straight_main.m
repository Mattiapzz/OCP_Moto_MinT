...
%ocp.setup(Straight_data);
%ocp.setup('../../data/Straight_Data.lua');
ocp.setup('../../data/Straight_Data.rb');
ocp.infoLevel(4);
...
%tracked = {<'xx1'>,<'xx2'>,...}
%tracked = {};
%Straight_Mex('set_tracked',obj,tracked);
...
%%clear mex
%x = Straight_Mex('get_raw_solution',obj);
%J = Straight_Mex('eval_JF',obj,x);
%f = Straight_Mex('eval_F',obj,x);
