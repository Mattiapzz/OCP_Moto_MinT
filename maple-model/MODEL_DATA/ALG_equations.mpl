...
(t) = 0, Mxr(t) = 0];
alg_constr_slips := [alpha__r(t) = -arctan(1/(-Omega(t)*y__r(t)+u(t)-diff(x__r
(t),t))*(-Omega(t)*x__r(t)+v(t)+diff(y__r(t),t))), alpha__f(t) = -arctan(1/(-
Omega(t)*y__f(t)+u(t)+diff(x__f(t),t)+delta__f(t)*(Omega(t)*x__f(t)+v(t)+diff(
y__f(t),t)))*(-delta__f(t)*diff(x__f(t),t)+diff(y__f(t),t)+(Omega(t)*y__f(t)-u
(t))*delta__f(t)+Omega(t)*x__f(t)+v(t))), lambda__r(t) = (-diff(x__r(t),t)-cos
(phi(t))*omega__r(t)*rtr+(-rr+rtr)*omega__r(t)-Omega(t)*y__r(t)+u(t))/(Omega(t
)*y__r(t)-u(t)+diff(x__r(t),t)), lambda__f(t) = (-diff(x__f(t),t)-delta__f(t)*
diff(y__f(t),t)+cos(phi__f(t))*omega__f(t)*rtf+(-Omega(t)*x__f(t)-v(t))*
delta__f(t)+Omega(t)*y__f(t)+(rf-rtf)*omega__f(t)-u(t))/(diff(x__f(t),t)+
delta__f(t)*diff(y__f(t),t)+(Omega(t)*x__f(t)+v(t))*delta__f(t)-Omega(t)*y__f(
t)+u(t))];
alg_constr_slips := [alpha__r(t) = -arctan(1/(-Omega(t)*y__r(t)+u(t)-diff(x__r
(t),t))*(-Omega(t)*x__r(t)+v(t)+diff(y__r(t),t))), alpha__f(t) = -arctan(1/(-
Omega(t)*y__f(t)+u(t)+diff(x__f(t),t)+delta__f(t)*(Omega(t)*x__f(t)+v(t)+diff(
...
x__rdr+(L__b+x__off)*m__wf+m__m*x__Rear)/(m__m+m__rdr+m__delta+m__swa+m__wf+
m__wr), YG = 0, ZG = (((L__swa-x__Swing)*m__swa+L__swa*m__wr)*sin(eta__00)+cos
(theta__d__00)*h__rdr*m__rdr+z__Swing*m__swa*cos(eta__00)+m__rdr*z__rdr+(-
s__fs+s__f__00)*m__wf+m__m*z__Rear+z__delta*m__delta)/(m__m+m__rdr+m__delta+
...
*h__rdr*m__rdr+m__rdr*z__rdr+(-s__fs+s__f__00)*m__wf+m__m*z__Rear+z__delta*
m__delta))*cos(eta__00)+2*(m__swa*(-L__swa+x__Swing)-L__swa*m__wr)*(cos(
theta__d__00)*h__rdr*m__rdr+m__rdr*z__rdr+(-s__fs+s__f__00)*m__wf+m__m*z__Rear
...
z__rdr*m__swa+(z__rdr-s__f__00+s__fs)*m__wf+(z__rdr-z__delta)*m__delta+(z__rdr
-z__Rear)*m__m+z__rdr*m__wr)*m__rdr*h__rdr*cos(theta__d__00)+((L__swa^2-2*
L__swa*x__Swing+z__rdr^2+x__Swing^2)*m__rdr+(L__swa^2-2*L__swa*x__Swing+
...
m__swa+m__wf+m__wr), IY = ((-2*h__rdr*(m__swa*(-L__swa+x__Swing)-L__swa*m__wr)
*m__rdr*sin(theta__d__00)-2*m__swa*z__Swing*h__rdr*m__rdr*cos(theta__d__00)+((
...
2*x__Swing*x__delta-2*z__delta*z__Swing)*m__delta-2*m__m*(-L__swa*x__Rear+
x__Rear*x__Swing+z__Rear*z__Swing))*m__swa+2*L__swa*m__wr*((L__b+x__off)*m__wf
+(L__b+x__delta)*m__delta+m__m*x__Rear))*cos(eta__00)+(-2*sin(theta__d__00)*
h__rdr*m__rdr*m__swa*z__Swing+2*h__rdr*(m__swa*(-L__swa+x__Swing)-L__swa*m__wr
)*m__rdr*cos(theta__d__00)+((-2*L__swa*z__rdr-2*x__rdr*z__Swing+2*z__rdr*
...
(-s__fs+s__f__00)*m__wf+m__m*z__Rear+z__delta*m__delta)*L__swa*m__wr)*sin(
eta__00)-2*h__rdr*m__rdr*(-x__rdr*m__swa+(L__b-x__rdr+x__delta)*m__delta+(L__b
+x__off-x__rdr)*m__wf+(-x__rdr+x__Rear)*m__m-x__rdr*m__wr)*sin(theta__d__00)+2
*(z__rdr*m__swa+(z__rdr-s__f__00+s__fs)*m__wf+(z__rdr-z__delta)*m__delta+(
z__rdr-z__Rear)*m__m+z__rdr*m__wr)*m__rdr*h__rdr*cos(theta__d__00)+((L__swa^2-\
2*L__swa*x__Swing+h__rdr^2+x__rdr^2+z__rdr^2+x__Swing^2+z__Swing^2)*m__swa+(
...
2-2*z__rdr*z__delta+x__delta^2+z__delta^2)*m__delta+(h__rdr^2+x__Rear^2-2*
...
m__rdr*x__rdr+(L__b+x__delta)*m__delta+(L__b+x__off)*m__wf+m__m*x__Rear))*cos(
eta__00)-2*z__Swing*(sin(theta__d__00)*h__rdr*m__rdr+m__rdr*x__rdr+(L__b+
x__delta)*m__delta+(L__b+x__off)*m__wf+m__m*x__Rear)*m__swa*sin(eta__00)+((-
...
(Ix__rdr-Iz__rdr))*cos(theta__d__00)^2-2*h__rdr*m__rdr*(-x__rdr*m__swa+(L__b-
x__rdr+x__delta)*m__delta+(L__b+x__off-x__rdr)*m__wf+(-x__rdr+x__Rear)*m__m-
x__rdr*m__wr)*sin(theta__d__00)+((h__rdr^2+x__rdr^2+z__Swing^2)*m__rdr+(L__b^2
...
Ix__swa-Iz__swa))*sin(eta__00)-h__rdr*(m__swa*(-L__swa+x__Swing)-L__swa*m__wr)
*m__rdr*cos(theta__d__00)-sin(theta__d__00)*h__rdr*m__rdr*m__swa*z__Swing+((
...
z__Rear+x__Rear*z__Swing+z__Rear*x__Swing))*m__swa+L__swa*m__wr*(m__rdr*z__rdr
+(-s__fs+s__f__00)*m__wf+m__m*z__Rear+z__delta*m__delta))*cos(eta__00)+(-
m__swa*z__Swing*h__rdr*m__rdr*cos(theta__d__00)+h__rdr*(m__swa*(-L__swa+
x__Swing)-L__swa*m__wr)*m__rdr*sin(theta__d__00)+((-L__swa*x__rdr+x__rdr*
x__Swing-z__rdr*z__Swing)*m__rdr+((-L__b-x__off)*L__swa+(-s__f__00+s__fs)*
z__Swing+x__Swing*(L__b+x__off))*m__wf+((-L__b-x__delta)*L__swa-z__delta*
z__Swing+x__Swing*(L__b+x__delta))*m__delta+m__m*(-L__swa*x__Rear+x__Rear*
x__Swing-z__Rear*z__Swing))*m__swa-(m__rdr*x__rdr+(L__b+x__off)*m__wf+(L__b+
x__delta)*m__delta+m__m*x__Rear)*L__swa*m__wr)*sin(eta__00)+(((h__rdr^2*m__rdr
...
))*sin(theta__d__00)-(-x__rdr*m__swa+(L__b-x__rdr+x__delta)*m__delta+(L__b+
x__off-x__rdr)*m__wf+(-x__rdr+x__Rear)*m__m-x__rdr*m__wr)*h__rdr*m__rdr)*cos(
theta__d__00)+h__rdr*(z__rdr*m__swa+(z__rdr-s__f__00+s__fs)*m__wf+(z__rdr-
z__delta)*m__delta+(z__rdr-z__Rear)*m__m+z__rdr*m__wr)*m__rdr*sin(theta__d__00
)+((L__swa*z__Swing+x__rdr*z__rdr-x__Swing*z__Swing)*m__rdr+(z__Swing*L__swa-
z__Swing*x__Swing+(-s__fs+s__f__00)*(L__b+x__off))*m__wf+(z__Swing*L__swa-
z__Swing*x__Swing+z__delta*(L__b+x__delta))*m__delta+(L__swa*z__Swing+x__Rear*
...
ALGCON := [-cos(theta(t)+epsilon)*delta(t)+delta__f(t)*cos(phi(t)), -sin(
phi__f(t))*cos(phi(t))+cos(phi__f(t))*sin(phi(t))-sin(theta(t)+epsilon)*(cos(
phi(t))*cos(phi__f(t))+sin(phi(t))*sin(phi__f(t)))*delta(t), (L__b+x__off)*cos
(theta(t)+epsilon)+sin(theta(t)+epsilon)*(s__fs-s__f(t))-delta__f(t)*sin(
phi__f(t))*(rf-rtf)-x__f(t), ((-rf+rtf)*cos(phi__f(t))-z__f(t)-rtf)*sin(phi(t)
)+(sin(phi__f(t))*(rf-rtf)-y__f(t))*cos(phi(t))+delta(t)*x__off, (-s__fs+s__f(
t))*cos(theta(t)+epsilon)+(L__b+x__off)*sin(theta(t)+epsilon)+((-rf+rtf)*cos(
phi__f(t))-z__f(t)-rtf)*cos(phi(t))+sin(phi(t))*((-rf+rtf)*sin(phi__f(t))+y__f
(t))+h(t), -L__swa*sin(eta(t))*sin(theta(t)+epsilon)-L__swa*cos(eta(t))*cos(
theta(t)+epsilon)+x__r(t), (-rtr-z__r(t))*sin(phi(t))-cos(phi(t))*y__r(t), 
L__swa*sin(eta(t))*cos(theta(t)+epsilon)-L__swa*cos(eta(t))*sin(theta(t)+
epsilon)+(-rtr-z__r(t))*cos(phi(t))+sin(phi(t))*y__r(t)-rr+rtr+h(t)];
